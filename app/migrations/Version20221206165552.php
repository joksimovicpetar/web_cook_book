 ...
 */
final class Version20221206165552 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE recipe DROP category_id, CHANGE description description TEXT NOT NULL');
    }
}
